...
day1 = float(input('Enter Rainfall for Day 1: '))
day2 = float(input('Enter Rainfall for Day 2: '))
day3 = float(input('Enter Rainfall for Day 3: '))
day4 = float(input('Enter Rainfall for Day 4: '))
day5 = float(input('Enter Rainfall for Day 5: '))
day6 = float(input('Enter Rainfall for Day 6: '))
day7 = float(input('Enter Rainfall for Day 7: '))
